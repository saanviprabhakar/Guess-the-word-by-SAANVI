...
charAt1 = word.charAt(1);//getting letter no. one
console.log(charAt1);

length_divide_2 = Math.floor(word.length/2);
charAt2 = word.charAt(length_divide_2); //getting letter no. two
console.log(charAt2);


length_minus_1 = word.length - 1;
charAt3 = word.charAt(length_minus_1); //getting letter no. three
console.log(charAt3);
